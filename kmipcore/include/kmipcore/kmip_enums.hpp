...
inline constexpr int32_t KMIP_MAX_MESSAGE_SIZE = 8192;
/** Suggested buffer size for human-readable error messages. */
inline constexpr int32_t KMIP_ERROR_MESSAGE_SIZE = 200;
...
inline constexpr int32_t KMIP_UNSET = -1;

/**
 * @brief Returns the lower of two values.
 * @tparam T Comparable numeric/value type.
 */
template<typename T> constexpr T KMIP_MIN(T a, T b) {
  return (a < b) ? a : b;
}

inline constexpr int32_t KMIP_OK = 0;
inline constexpr int32_t KMIP_NOT_IMPLEMENTED = -1;
inline constexpr int32_t KMIP_ERROR_BUFFER_FULL = -2;
inline constexpr int32_t KMIP_ERROR_ATTR_UNSUPPORTED = -3;
inline constexpr int32_t KMIP_TAG_MISMATCH = -4;
inline constexpr int32_t KMIP_TYPE_MISMATCH = -5;
inline constexpr int32_t KMIP_LENGTH_MISMATCH = -6;
inline constexpr int32_t KMIP_PADDING_MISMATCH = -7;
inline constexpr int32_t KMIP_BOOLEAN_MISMATCH = -8;
inline constexpr int32_t KMIP_ENUM_MISMATCH = -9;
inline constexpr int32_t KMIP_ENUM_UNSUPPORTED = -10;
inline constexpr int32_t KMIP_INVALID_FOR_VERSION = -11;
inline constexpr int32_t KMIP_MEMORY_ALLOC_FAILED = -12;
inline constexpr int32_t KMIP_IO_FAILURE = -13;
inline constexpr int32_t KMIP_EXCEED_MAX_MESSAGE_SIZE = -14;
inline constexpr int32_t KMIP_MALFORMED_RESPONSE = -15;
inline constexpr int32_t KMIP_OBJECT_MISMATCH = -16;
inline constexpr int32_t KMIP_ARG_INVALID = -17;
inline constexpr int32_t KMIP_ERROR_BUFFER_UNDERFULL = -18;
inline constexpr int32_t KMIP_INVALID_ENCODING = -19;
inline constexpr int32_t KMIP_INVALID_FIELD = -20;
inline constexpr int32_t KMIP_INVALID_LENGTH = -21;

// ---------------------------------------------------------------------------
// Enumerations
// ---------------------------------------------------------------------------

enum attestation_type : int32_t {
  // KMIP 1.2
...
enum batch_error_continuation_option : int32_t {
  // KMIP 1.0
...
enum block_cipher_mode : int32_t {
  // KMIP 1.0
  KMIP_BLOCK_CBC = 0x01,
  KMIP_BLOCK_ECB = 0x02,
...
enum cryptographic_algorithm : int32_t {
...
enum cryptographic_usage_mask : int32_t {
...
enum digital_signature_algorithm : int32_t {
  // KMIP 1.1
...
enum encoding_option : int32_t {
  // KMIP 1.1
  KMIP_ENCODE_NO_ENCODING = 0x01,
  KMIP_ENCODE_TTLV_ENCODING = 0x02
};

enum hashing_algorithm : int32_t {
  // KMIP 1.0
  KMIP_HASH_MD2 = 0x01,
  KMIP_HASH_MD4 = 0x02,
  KMIP_HASH_MD5 = 0x03,
...
enum key_compression_type : int32_t {
  // KMIP 1.0
...
enum mask_generator : int32_t {
  // KMIP 1.4
  KMIP_MASKGEN_MGF1 = 0x01
};

enum name_type : int32_t {
  // KMIP 1.0
...
enum protection_storage_mask : int32_t {
  // KMIP 2.0
...
enum revocation_reason_type : int32_t {
  // KMIP 1.0
  UNSPECIFIED = 0x01,
  KEY_COMPROMISE = 0x02,
  CA_COMPROMISE = 0x03,
  ...
  REVOCATION_EXTENSIONS = static_cast<int32_t>(0x80000000u)
};

/** @brief KMIP secret payload data type identifiers. */
enum secret_data_type : int32_t {
  // KMIP 1.0
  PASSWORD = 0x01,
  SEED = 0x02,
  SECRET_DATA_EXTENSIONS = static_cast<int32_t>(0x80000000u)
};
